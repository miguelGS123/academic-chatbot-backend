...
export const GlobalChat =
  forwardRef<GlobalChatRef, GlobalChatProps>(
    function GlobalChat(
      {
        userId,
      ...
      return (
        <SectionCard title="Chatzitho">
          <AppText
            ...
            variant="caption"
          >
            Consulta cursos, docentes,
            pagos, avance académico,
            certificaciones o información
            institucional.
          </AppText>
